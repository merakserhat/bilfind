...
import 'package:bilfind_app/screens/admin_panel/widgets/admin_view_reported_post_item.dart';
...
class _AdminPanelScreenState extends State<AdminPanelScreen> {
  ...
  getData() async {
    reportedPosts = await ReportService.getReportsList();
    setState(() {
