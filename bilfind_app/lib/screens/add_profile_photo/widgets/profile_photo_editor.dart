...
class ProfilePhotoEditor extends StatelessWidget {
  const ProfilePhotoEditor({
    ...
    required this.isOwnUser, required this.isPhotoAdded,
  }) : super(key: key);
            ...
            child: isLoading
                ...
                : Row(
                    ...
                    children: [
                      ...
                      isOwnUser
                          ? InkWell(
                              onTap: selectedImage == null || isPhotoAdded
                                  ? onEditClicked
                                  : onSaveClicked,
                              child: Container(
                                width: 40,
                                ...
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(100),
                                  color: selectedImage == null || isPhotoAdded
                                      ? AppColors.black4
                                      : AppColors.bilkentBlue,
                                ),
                                child: Center(
                                  child: Icon(
                                    selectedImage == null || isPhotoAdded
                                        ? Icons.edit
                                        : Icons.check,
                                    color: AppColors.mutedWhite,
                                  ),
